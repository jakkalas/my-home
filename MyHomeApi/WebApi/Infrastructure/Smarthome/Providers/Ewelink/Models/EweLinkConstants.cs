...
{
    public static class EweLinkConstants
    {
        public static readonly IDictionary<int, string> DeviceTypeUuid = new ConcurrentDictionary<int, string>()
        {
            [1] = "SOCKET",
            [2] = "SOCKET_2",
            [3] = "SOCKET_3",
        ...
        public static readonly IDictionary<string, int> DevicesChannelLengths = new ConcurrentDictionary<string, int>()
        {
            ["SOCKET"] = 1,
            ["SWITCH_CHANGE"] = 1,
